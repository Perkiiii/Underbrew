...
public class ProcessingInputSlotUI : MonoBehaviour, IDropHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    private void Awake()
    {
        ...
        if (labelText == null)
        {
            var labelTransform = transform.Find("Input Name");
        ...
        if (owner == null)
            owner = GetComponentInParent<ProcessingStationUI>(true);

        if (rootCanvas == null)
            rootCanvas = GetComponentInParent<Canvas>();
    }

    public void Initialize(ProcessingStationUI processingOwner)
    {
    ...
    public void SetItem(ItemData itemData)
    {
        ...
        if (labelText != null)
            labelText.text = itemData != null ? itemData.ItemName : "Drop Item Here";
    }
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        owner.TrySetInputItem(dragSlot.ItemData, dragSlot.BoundSlotIndex);
    }
    ...
    public void OnBeginDrag(PointerEventData eventData)
    {
        ...
        dragIconObject = new GameObject("ProcessingInputDragIcon", typeof(RectTransform), typeof(CanvasRenderer), typeof(Image));
    ...
    public void TryMoveReservedItemToSlot(int targetSlotIndex)
    {
        ...
        owner.MoveReservedInputToSlot(targetSlotIndex);
    }
